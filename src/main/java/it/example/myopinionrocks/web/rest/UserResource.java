...
import it.example.myopinionrocks.config.Constants;
import it.example.myopinionrocks.domain.User;
import it.example.myopinionrocks.repository.UserRepository;
import it.example.myopinionrocks.security.AuthoritiesConstants;
import it.example.myopinionrocks.service.MailService;
...
import it.example.myopinionrocks.web.rest.errors.EmailAlreadyUsedException;
import it.example.myopinionrocks.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link it.example.myopinionrocks.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
