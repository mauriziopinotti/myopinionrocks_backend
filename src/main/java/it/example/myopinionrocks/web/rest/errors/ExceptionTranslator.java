package it.example.myopinionrocks.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof it.example.myopinionrocks.service.EmailAlreadyUsedException ||
            ex instanceof it.example.myopinionrocks.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof it.example.myopinionrocks.service.InvalidPasswordException
